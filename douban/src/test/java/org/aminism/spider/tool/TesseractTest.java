...
public class TesseractTest {
    ...
    private final String datapath = base+"/src/main/resources/";
    private final String testResourcesDataPath =base+"/src/test/resources/test-data";
    ...
    public void testDoOCR_File() throws Exception {
        ...
        logger.info(new File(datapath).getPath());
    ...
    public void testDoOCR_BufferedImage() throws Exception {
        ...
        File imageFile = new File(testResourcesDataPath, "cha.jpg");
        BufferedImage bi = ImageIO.read(imageFile);
        MyImgFilter filter=new MyImgFilter(bi);
        bi=filter.changeGrey();

        //bi=ImageHelper.getScaledInstance(bi,5,5);
        String expResult = "relation";
        String result = instance.doOCR(bi);
        logger.info(result);
        File file = new File("cha" + ".jpg");
